...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_CommandLine_Error">CommandLine.Error</a><br />&nbsp;&nbsp;&nbsp;&nbsp;CommandLine.NoVerbSelectedError<br />
...
**VB**<br />
``` VB
Public NotInheritable Class NoVerbSelectedError
	Inherits Error
```

**C++**<br />
``` C++
public ref class NoVerbSelectedError sealed : public Error
```

**F#**<br />
``` F#
[<SealedAttribute>]
type NoVerbSelectedError =  
    class
        inherit Error
    end
```

The NoVerbSelectedError type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_CommandLine_NoVerbSelectedError__ctor">NoVerbSelectedError</a></td><td>
Initializes a new instance of the NoVerbSelectedError class</td></tr></table>&nbsp;
<a href="#noverbselectederror-class">Back to Top</a>
