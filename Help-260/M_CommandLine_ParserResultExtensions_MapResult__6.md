...
**C#**<br />
``` C#
public static TResult MapResult<T1, T2, T3, T4, T5, TResult>(
...
``` VB
<ExtensionAttribute>
Public Shared Function MapResult(Of T1, T2, T3, T4, T5, TResult) ( 
