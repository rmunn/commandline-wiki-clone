...
Applied to a static property that yields a sequence of <a href="T_CommandLine_Text_Example">Example</a>, provides data to render usage section of help screen.


## Inheritance Hierarchy
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="https://docs.microsoft.com/dotnet/api/system.attribute" target="_blank">System.Attribute</a><br />&nbsp;&nbsp;&nbsp;&nbsp;CommandLine.Text.UsageAttribute<br />
...
**VB**<br />
``` VB
Public NotInheritable Class UsageAttribute
	Inherits Attribute
```

**C++**<br />
``` C++
public ref class UsageAttribute sealed : public Attribute
```
...
The UsageAttribute type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_CommandLine_Text_UsageAttribute__ctor">UsageAttribute</a></td><td>
Initializes a new instance of the UsageAttribute class</td></tr></table>&nbsp;
<a href="#usageattribute-class">Back to Top</a>
