...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank">System.Object</a><br />&nbsp;&nbsp;CSharpx.Either(TLeft, TRight)<br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_CSharpx_Left_2">CSharpx.Left(TLeft, TRight)</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_CSharpx_Right_2">CSharpx.Right(TLeft, TRight)</a><br />
...
**VB**<br />
``` VB
Friend MustInherit Class Either(Of TLeft, TRight)
```

**C++**<br />
``` C++
generic<typename TLeft, typename TRight>
internal ref class Either abstract
```

**F#**<br />
``` F#
[<AbstractClassAttribute>]
type Either<'TLeft, 'TRight> =  class end
```


#### Type Parameters
&nbsp;<dl><dt>TLeft</dt><dd /><dt>TRight</dt><dd /></dl>&nbsp;
The Either(TLeft, TRight) type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_CSharpx_Either_2__ctor">Either(TLeft, TRight)</a></td><td>
Initializes a new instance of the Either(TLeft, TRight) class</td></tr></table>&nbsp;
<a href="#either(*tleft*,-*tright*)-class">Back to Top</a>
