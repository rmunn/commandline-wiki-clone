...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank">System.Object</a><br />&nbsp;&nbsp;CommandLine.Infrastructure.LocalizableAttributeProperty<br />
...
**VB**<br />
``` VB
Friend Class LocalizableAttributeProperty
```

**C++**<br />
``` C++
internal ref class LocalizableAttributeProperty
```

**F#**<br />
``` F#
type LocalizableAttributeProperty =  class end
```

The LocalizableAttributeProperty type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_CommandLine_Infrastructure_LocalizableAttributeProperty__ctor">LocalizableAttributeProperty</a></td><td>
Initializes a new instance of the LocalizableAttributeProperty class</td></tr></table>&nbsp;
<a href="#localizableattributeproperty-class">Back to Top</a>
...
Serves as the default hash function.
 (Inherited from <a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank">Object</a>.)</td></tr><tr><td>![Private method](media/privmethod.gif "Private method")</td><td><a href="M_CommandLine_Infrastructure_LocalizableAttributeProperty_GetLocalizedValue">GetLocalizedValue</a></td><td /></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="https://docs.microsoft.com/dotnet/api/system.object.gettype#System_Object_GetType" target="_blank">GetType</a></td><td>
