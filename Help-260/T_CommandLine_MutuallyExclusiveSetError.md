...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_CommandLine_Error">CommandLine.Error</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_CommandLine_NamedError">CommandLine.NamedError</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CommandLine.MutuallyExclusiveSetError<br />
...
**VB**<br />
``` VB
Public NotInheritable Class MutuallyExclusiveSetError
	Inherits NamedError
```

**C++**<br />
``` C++
public ref class MutuallyExclusiveSetError sealed : public NamedError
```

**F#**<br />
``` F#
[<SealedAttribute>]
type MutuallyExclusiveSetError =  
    class
        inherit NamedError
    end
```

The MutuallyExclusiveSetError type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_CommandLine_MutuallyExclusiveSetError__ctor">MutuallyExclusiveSetError</a></td><td>
Initializes a new instance of the MutuallyExclusiveSetError class</td></tr></table>&nbsp;
<a href="#mutuallyexclusiveseterror-class">Back to Top</a>
...
Name information relative to this error instance.
 (Inherited from <a href="T_CommandLine_NamedError">NamedError</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_CommandLine_MutuallyExclusiveSetError_SetName">SetName</a></td><td>
Option's set name.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_CommandLine_Error_StopsProcessing">StopsProcessing</a></td><td>
