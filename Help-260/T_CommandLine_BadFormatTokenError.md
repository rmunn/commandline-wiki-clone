...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_CommandLine_Error">CommandLine.Error</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_CommandLine_TokenError">CommandLine.TokenError</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CommandLine.BadFormatTokenError<br />
...
**VB**<br />
``` VB
Public NotInheritable Class BadFormatTokenError
	Inherits TokenError
```

**C++**<br />
``` C++
public ref class BadFormatTokenError sealed : public TokenError
```

**F#**<br />
``` F#
[<SealedAttribute>]
type BadFormatTokenError =  
    class
        inherit TokenError
    end
```

The BadFormatTokenError type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_CommandLine_BadFormatTokenError__ctor">BadFormatTokenError</a></td><td>
Initializes a new instance of the BadFormatTokenError class</td></tr></table>&nbsp;
<a href="#badformattokenerror-class">Back to Top</a>
