...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_CommandLine_Error">CommandLine.Error</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_CommandLine_NamedError">CommandLine.NamedError</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CommandLine.BadFormatConversionError<br />
...
**VB**<br />
``` VB
Public NotInheritable Class BadFormatConversionError
	Inherits NamedError
```

**C++**<br />
``` C++
public ref class BadFormatConversionError sealed : public NamedError
```

**F#**<br />
``` F#
[<SealedAttribute>]
type BadFormatConversionError =  
    class
        inherit NamedError
    end
```

The BadFormatConversionError type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_CommandLine_BadFormatConversionError__ctor">BadFormatConversionError</a></td><td>
Initializes a new instance of the BadFormatConversionError class</td></tr></table>&nbsp;
<a href="#badformatconversionerror-class">Back to Top</a>
