...
**C#**<br />
``` C#
public static ParserResult<Object> ParseArguments<T1, T2>(
	this Parser parser,
...
``` VB
<ExtensionAttribute>
Public Shared Function ParseArguments(Of T1, T2) ( 
	parser As Parser,
...
#### Type Parameters
&nbsp;<dl><dt>T1</dt><dd>The type of the first verb.</dd><dt>T2</dt><dd>The type of the second verb.</dd></dl>
