...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_CommandLine_Error">CommandLine.Error</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_CommandLine_NamedError">CommandLine.NamedError</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CommandLine.SetValueExceptionError<br />
...
**VB**<br />
``` VB
Public NotInheritable Class SetValueExceptionError
	Inherits NamedError
```

**C++**<br />
``` C++
public ref class SetValueExceptionError sealed : public NamedError
```

**F#**<br />
``` F#
[<SealedAttribute>]
type SetValueExceptionError =  
    class
        inherit NamedError
    end
```
...
## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_CommandLine_SetValueExceptionError__ctor">SetValueExceptionError</a></td><td>
Initializes a new instance of the SetValueExceptionError class</td></tr></table>&nbsp;
<a href="#setvalueexceptionerror-class">Back to Top</a>

## Properties
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_CommandLine_SetValueExceptionError_Exception">Exception</a></td><td>
The expection thrown from Property.SetValue</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_CommandLine_NamedError_NameInfo">NameInfo</a></td><td>
...
Error type discriminator, defined as <a href="T_CommandLine_ErrorType">ErrorType</a> enumeration.
 (Inherited from <a href="T_CommandLine_Error">Error</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_CommandLine_SetValueExceptionError_Value">Value</a></td><td>
The value that had to be set to the property</td></tr></table>&nbsp;
<a href="#setvalueexceptionerror-class">Back to Top</a>
