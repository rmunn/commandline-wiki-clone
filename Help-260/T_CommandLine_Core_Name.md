...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_CommandLine_Core_Token">CommandLine.Core.Token</a><br />&nbsp;&nbsp;&nbsp;&nbsp;CommandLine.Core.Name<br />
...
Friend Class Name
	Inherits Token
	Implements IEquatable(Of Name)
```

**C++**<br />
``` C++
internal ref class Name : public Token, 
	IEquatable<Name^>
```
...
## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_CommandLine_Core_Name__ctor">Name</a></td><td>
