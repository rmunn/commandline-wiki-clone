...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_CommandLine_Error">CommandLine.Error</a><br />&nbsp;&nbsp;&nbsp;&nbsp;CommandLine.VersionRequestedError<br />
...
**VB**<br />
``` VB
Public NotInheritable Class VersionRequestedError
	Inherits Error
```

**C++**<br />
``` C++
public ref class VersionRequestedError sealed : public Error
```

**F#**<br />
``` F#
[<SealedAttribute>]
type VersionRequestedError =  
    class
        inherit Error
    end
```

The VersionRequestedError type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_CommandLine_VersionRequestedError__ctor">VersionRequestedError</a></td><td>
Initializes a new instance of the VersionRequestedError class</td></tr></table>&nbsp;
<a href="#versionrequestederror-class">Back to Top</a>
