...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_CommandLine_Error">CommandLine.Error</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_CommandLine_TokenError">CommandLine.TokenError</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CommandLine.BadVerbSelectedError<br />
...
**VB**<br />
``` VB
Public NotInheritable Class BadVerbSelectedError
	Inherits TokenError
```

**C++**<br />
``` C++
public ref class BadVerbSelectedError sealed : public TokenError
```

**F#**<br />
``` F#
[<SealedAttribute>]
type BadVerbSelectedError =  
    class
        inherit TokenError
    end
```

The BadVerbSelectedError type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_CommandLine_BadVerbSelectedError__ctor">BadVerbSelectedError</a></td><td>
Initializes a new instance of the BadVerbSelectedError class</td></tr></table>&nbsp;
<a href="#badverbselectederror-class">Back to Top</a>
...
Determines whether the specified <a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank">Object</a> is equal to the current <a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank">Object</a>.
 (Inherited from <a href="T_CommandLine_TokenError">TokenError</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_CommandLine_Error_Equals">Equals(Error)</a></td><td>
...
Returns a value that indicates whether the current instance and a specified <a href="T_CommandLine_TokenError">TokenError</a> have the same value.
 (Inherited from <a href="T_CommandLine_TokenError">TokenError</a>.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="https://docs.microsoft.com/dotnet/api/system.object.finalize#System_Object_Finalize" target="_blank">Finalize</a></td><td>
...
Serves as a hash function for a particular type.
 (Inherited from <a href="T_CommandLine_TokenError">TokenError</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="https://docs.microsoft.com/dotnet/api/system.object.gettype#System_Object_GetType" target="_blank">GetType</a></td><td>
