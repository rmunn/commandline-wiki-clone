...
```cssharp
      ...
      var helpText= HelpText.AutoBuild(result, h =>
       ...
       //for complete example see example1 and exampl2
...
Help is generated without a newline between options and setting heading and copyrigt text as displayed below:
```
Myapp 2.0.0-beta
